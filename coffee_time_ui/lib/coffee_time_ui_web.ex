defmodule CoffeeTimeUiWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: CoffeeTimeUiWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/coffee_time_ui_web/templates",
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {CoffeeTimeUiWeb.LayoutView, "live.html"}
  ...
  defp view_helpers do
    quote do
      ...
      import CoffeeTimeUiWeb.ErrorHelpers
      import CoffeeTimeUiWeb.Gettext
      alias CoffeeTimeUiWeb.Router.Helpers, as: Routes
    end
  end
