defmodule CoffeeTimeUiWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CoffeeTimeUiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CoffeeTimeUiWeb.Gettext, "errors", msg, opts)
    end
  end
